...
public class CameraController : MonoBehaviour
{
    ...
    void Init()
    {
        uiManager.moveForward += MoveForward;
        uiManager.moveBackward += MoveBackward;
        uiManager.moveLeft += MoveLeft;
        uiManager.moveRight += MoveRight;

        uiManager.turnLeft += TurnLeft;
        uiManager.turnRight += TurnRight;
        //uiManager.turnUp += TurnUp;
        //uiManager.turnDown += TurnDown;

        uiManager.moveUp += MoveUp;
        uiManager.moveDown += MoveDown;

        uiManager.changeRotateMode += ChangeRotateMode;
    }
